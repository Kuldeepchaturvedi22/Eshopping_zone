...
find /usr/share/nginx/html -name "*.js" -exec sed -i "s|VITE_APP_NAME_PLACEHOLDER|$APP_NAME|g" {} \;
find /usr/share/nginx/html -name "*.js" -exec sed -i "s|VITE_RAZORPAY_KEY_PLACEHOLDER|$RAZORPAY_KEY|g" {} \;
