...
//         setFormData({
//             ...product,
//             merchantEmail: product.merchantEmail || "", // keep value present
//         });
...
//             <input type="email" name="merchantEmail" placeholder="Merchant Email (owner)" value={formData.merchantEmail} onChange={handleChange} className="p-3 border rounded md:col-span-2" required />
...
//                     <p className="text-gray-500 text-xs">Merchant: {product.merchantEmail || "—"}</p>
...
export default function AdminProducts() {
    ...
    return (
        <div className="p-8 bg-black min-h-screen text-white">
            ...
            <form
                onSubmit={handleAddOrUpdateProduct}
                className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-10 bg-gray-900 p-6 rounded-xl shadow-lg"
            >
                <input
                    type="text"
                    name="productType"
                ...
                <select
                    ...
                    onChange={handleChange}
                    className="p-3 border rounded bg-gray-800 text-white"
                    required
                >
                    <option value="">Select Category</option>
                    <option value="Electronics">Electronics</option>
                ...
                <input
                    type="email"
                    name="merchantEmail"
                    placeholder="Merchant Email (owner)"
                    value={formData.merchantEmail}
                    onChange={handleChange}
                    className="p-3 border rounded bg-gray-800 text-white placeholder-gray-400 md:col-span-2"
                    required
                />
                <textarea
                    name="description"
            ...
            <div className="flex flex-col md:flex-row justify-between items-center mb-6 gap-4">
                <input
                    ...
                    value={searchTerm}
                    onChange={(e) => setSearchTerm(e.target.value)}
                    className="p-3 border rounded bg-gray-800 text-white placeholder-gray-400 w-full md:w-1/2"
                />
                <select
                    onChange={(e) => setSortOption(e.target.value)}
                    className="p-3 border rounded bg-gray-800 text-white w-full md:w-1/4"
                >
                    <option value="">Sort By</option>
                    <option value="price">Price (Low to High)</option>
                    <option value="stock">Stock (High to Low)</option>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {filteredProducts.map((product) => (
                    <div
                        ...
                        className="bg-gray-900 p-4 rounded-xl shadow-md hover:shadow-xl transition duration-300 transform hover:scale-105"
                    >
                        <img
                            src={product.image}
                        ...
                        <p className="text-gray-500 text-xs">
                            Merchant: {product.merchantEmail || "—"}
                        </p>
                        <div className="flex gap-2 mt-3">
                            <button
