...
export default function Navbar() {
    ...
    return (<div className="fixed inset-0 w-full h-20 bg-black/90 backdrop-blur-lg z-50">
                        ...
                        <div className="relative p-4">
                            ...
                            <div className="flex items-center gap-3 mb-6">
                                <div className="relative flex-1">
                                    <div
                                        className="absolute -inset-0.5 bg-gradient-to-r from-purple-600/30 to-blue-600/30 rounded-xl blur opacity-50"></div>
                                    <input
                                        type="text"
