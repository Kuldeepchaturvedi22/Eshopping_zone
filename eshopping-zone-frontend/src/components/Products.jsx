            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                {sortedProducts.map((product) => (
                    <div
                        key={product.productId}
                        id={`product-${product.productId}`}
                        className="group bg-gradient-to-br from-gray-800/90 to-gray-900/90 backdrop-blur-lg rounded-2xl shadow-2xl hover:shadow-purple-500/25 transform hover:scale-105 transition-all duration-300 p-6 border border-gray-700/50 hover:border-purple-400/50 relative overflow-hidden cursor-pointer"
                            ...
                            <div className="pt-4">
                                {isInCart(product.productId) ? (
                                    <button
                                        onClick={(e) => {
                                            e.stopPropagation();
                                            handleRemoveItemWithFeedback(product.productId);
                                        }}
