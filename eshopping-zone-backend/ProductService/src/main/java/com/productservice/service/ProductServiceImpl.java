...
public class ProductServiceImpl implements ProductService {
    ...
    @Override
    public ResponseEntity<List<Product>> findByMerchantEmail(String email){
        List<Product> products = productRepository.findByMerchantEmail(email);
        if (products.isEmpty()) {
            throw new ProductNotFoundException("No products found for merchant with email: " + email);
        }
