...
public class ProductController {
    ...
    @Operation(summary = "Find By Merchant Email")
    @GetMapping("/merchant/{email}")
    public ResponseEntity<List<Product>> findByMerchantEmail(@PathVariable("email") String email) {
        return productService.findByMerchantEmail(email);
    }
}